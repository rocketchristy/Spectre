...
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.USERS TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.TOKENS TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.SERIES TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.STYLES TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.STYLE_MODIFIERS TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.PRODUCT_TYPES TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.PRODUCT_VARIANTS TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.VARIANT_IMAGES TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.INVENTORY TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.CARTS TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.CART_ITEMS TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.ADDRESSES TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.ORDERS TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.ORDER_ADDRESSES TO <Your USERGRP>;
GRANT SELECT, INSERT, UPDATE, DELETE 
    ON <Your HLQ>.ORDER_ITEMS TO <Your USERGRP>;
